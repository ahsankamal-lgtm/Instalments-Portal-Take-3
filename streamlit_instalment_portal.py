...
if not st.session_state.started:
    ...
    st.image("https://upload.wikimedia.org/wikipedia/commons/7/77/Electric_bike_icon.png", width=150)

    st.markdown(
        """
        ### 🚴 Welcome!
        Apply for your **Electric Bike on Installments** and get instant eligibility results.

        #### 🛠 Process
        1. Fill in your **Applicant Information**  
        2. Complete the **Evaluation Inputs**  
        3. View your **Results & Eligibility Decision**  
        4. Save approved applicants to the **Database**
